...
function UvcCam( opts ) {
  ...
  // this is default
  if(_.has(this.opts, "emulateraspicam")) { this.raspicamOpts( ); }
...
//        console.log(this.shotnumber);
//	this.opts["o"] = round(this.opts["o"] / 1000);
  }

  if(typeof this.opts["t"] !== "undefined") {
	this.opts["t"] = Math.round(this.opts["t"] / 1000);
  }
...
UvcCam.prototype.defaultOpts = function(){
  ...
  this.opts.S = this.opts.S || 45;
  this.opts.B = this.opts.B || 190;
  this.opts.C = this.opts.C || 35;
  this.opts.G = this.opts.G || 50;
...
console.log("START");
  ...
  switch(this.opts.mode){
    ...
    case 'timelapse':
      ...
      if(typeof this.opts.timelapse === "undefined" && typeof this.opts.t === "undefined"){
      ...
      if(typeof this.opts.timeout === "undefined" && typeof this.opts.emulateraspicam === "undefined"){
...
UvcCam.prototype.set = function(opt, value){
  ...
  if(this.emulateraspicam == true) { this.raspicamOpts( ); }
  console.log("setted. = ")
  console.log(this.opts);
};
